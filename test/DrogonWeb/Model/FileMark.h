...
class FileMark
{
  public:
     ...
     */
    explicit FileMark(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit FileMark(const Json::Value &pJson) noexcept(false);
     ...
     */
    FileMark(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where file_name = ?";
        return sql;                   
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where file_name = ?";
        return sql;                   
    }
